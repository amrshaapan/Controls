        ...
        <div class="col-12">
            ...
            <table class="table table-borderless">
                <thead>
                        ...
                        <td id="tg" colspan="4">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    ...
                                    <h6 class="text-center fonts">إمتحان شهادة إتمام الدراسة بمرحلة التعليم اﻻساسى</h6>
                                    <div class="a">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <!-- <h5 class="text-right line">{{studentSchools[2]}} <span style="padding-left: 5px;float: left;">{{studentSchools[1][0].committee.id}}</span></h5> -->
                                    <h5 class="text-right line">{{studentSchools[2] ? studentSchools[2][0].committee.committee_name : studentSchools[1][0].committee.committee_name}} <span style="padding-left: 5px;float: left;">{{studentSchools[2] ? studentSchools[2][0].committee.id : studentSchools[1][0].committee.id}}</span></h5>
                                    <h5 class="text-right line">{{studentSchools[2] ? studentSchools[2][0].school_name : studentSchools[1][0].school_name}} <span style="float: left;">{{index}}</span></h5>
                                </div>
                                <div class="col-2">
                                    <h5 class="text-center line customb">نظامى</h5>
                                    <!-- <h6 class="text-left line">  اﻻدارة : الشيخ زويد</h6> -->
                    ...
                    <tr>
                        <th class="text-center fonts" style="width:15%; font-size: 20px; border: 4px solid;">رقم الجلوس</th>
                        <th class="text-center fonts" style="font-size: 20px;border: 4px solid; ">اﻻسم</th>
                        <th class="text-center fonts" style="width:35%; font-size: 20px; border: 4px solid;">مواد الدور الثانى</th>
                        <th class="text-center fonts" style="width:7%; font-size: 20px; border: 4px solid;">الديانة</th>
                ...
                <tbody>
                    <tr v-for="studentSchool  in studentSchools[2]" style="line-height: 12px; font-size: 30px;font-weight: 900; ">
                        ...
                        <td class="text-right" style="font-size: 20px; border: 1px solid;">

                            <span class="badge badge-secondary" v-if="studentSchool.ar <= 39 ? 'back':'' || studentSchool.ar === 'غـ' ? 'back' : ''">  عربى</span>
                            <span class="badge badge-secondary" v-if="studentSchool.en <= 29 ? 'back':'' || studentSchool.en === 'غـ' ? 'back' : ''">انجليزى</span>
                            <span class="badge badge-secondary" v-if="studentSchool.total_math <= 29 ? 'back':'' || studentSchool.total_math === 'غـ' ? 'back' : ''">جبر</span>
                            <span class="badge badge-secondary" v-if="studentSchool.total_math <= 29 ? 'back':'' || studentSchool.total_math === 'غـ' ? 'back' : ''">هندسة</span>
                            <span class="badge badge-secondary" v-if="studentSchool.sci <= 19 ? 'back':'' || studentSchool.sci === 'غـ' ? 'back' : '' ">علوم</span>
                            <span class="badge badge-secondary" v-if="studentSchool.stu <= 19 ? 'back':'' || studentSchool.stu === 'غـ' ? 'back' : '' " >دراسات</span>
                    ...
                    <tr v-for="studentSchool  in studentSchools[1]" style="line-height: 12px; font-size: 30px;font-weight: 900; ">
                        <th class="text-center" scope="row" style="font-size: 23px; border: 1px solid;">
...
<div class="row" v-for="(studentSchools,index)  in students[2]" style="page-break-after: always;">
